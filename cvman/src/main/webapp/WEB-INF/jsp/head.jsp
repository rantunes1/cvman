...
<script type="text/javascript">
	var rootPath = '<c:url value="/js/cvman/application.js"/>/';

	$(document).ready(function() {
		try{
			$('<div id="preloader" style="display:none; position:fixed; top:3px; right:3px"><img src="<c:url value="/theme/images/preloader.png"/>"></img></div>')	
...
<script type="text/javascript" src="<c:url value="/js/cvman/application.js"/>"></script>