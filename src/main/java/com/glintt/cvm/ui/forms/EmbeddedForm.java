...
public class EmbeddedForm extends Form {
    private static final long serialVersionUID = 6301044446072585942L;
    ...
    protected void attachField(Object propertyId, Field field) {
        ...
        Layout layout = this.parentForm.getLayout();
    ...
    public boolean removeItemProperty(Object id) {
        ...
        this.parentForm.getLayout().removeComponent(this.fields.get(id));
