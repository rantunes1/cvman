...
@Entity
@XmlRootElement(name = "professional-info")
public class ProfessionalInfo extends AbstractEntity {
	...
	@Entity
	public static class Certification extends AbstractEntity {
		...
		@Entity
		public static class IssuingAuthority extends AbstractEntity {
	 ...
	 */
	@Entity
	public static class Copyright extends AbstractEntity {
	 ...
	 */
	@Entity
	public static class Contributor extends AbstractEntity {
	...
	@Entity
	public static class Employer extends AbstractEntity {
	...
	@Entity
	public static class Position extends AbstractEntity {
	...
	@Entity
	public static class TimePeriod extends AbstractEntity {
